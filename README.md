...
* Models
1. MLPerf Tiny Tracck Model.(MobilenetV1)
2. Pytorch models in torchhub Modelzoo.
...
ofa_pytorch is designed to work as a Pytorch plugin. We provide simplest APIs to introduce our FPGA-friendly quantization feature.
...
- The most common operators in pytorch are supported in quantizer, please refer to [support_op.md](https://github.com/Xilinx/Vitis-AI/blob/master/src/vai_quantizer/vai_q_pytorch/doc/support_op.md)  for details.

...
if __name__ == '__main__':
  ...
  print('Targeted macs range:', args.evo_search_targeted_min_macs, args.evo_search_targeted_max_macs)
  ...
  # while (targeted_min_macs <= targeted_max_macs and min_subnet_macs <= targeted_min_macs and targeted_max_macs <= max_subnet_macs):
  #   pass
